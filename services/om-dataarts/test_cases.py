# om-dataarts 模块全量测试用例（Python pytest 脚本）
# 本文件由 integration-test agent 融合生成，包含多个 issue 的测试交付件
...
@pytest.mark.p0
def test_api_community_dict_torchnpu_001(api_headers):
    """
    [正常流] 社区列表接口返回包含 Torch-NPU
    对应 TASK-1 | 优先级 P0 | 来源 PR #456
    """
    resp = requests.get(
...
@pytest.mark.p0
def test_api_community_dict_openubmc_002(api_headers):
    """
...
@pytest.mark.p0
def test_api_community_dict_ascendnpuir_003(api_headers):
    """
...
@pytest.mark.p0
def test_db_table_torchnpu_exists_004(db_conn):
    """
    [正常流] fact_torchnpu_practice 表存在且结构正确
    对应 TASK-2 | 优先级 P0 | 来源 PR #456
    """
    cur = db_conn.cursor()
    cur.execute("""
...
@pytest.mark.p0
def test_db_table_openubmc_exists_005(db_conn):
    """
...
@pytest.mark.p0
def test_db_table_ascendnpuir_exists_006(db_conn):
    """
...
@pytest.mark.p0
def test_db_torchnpu_has_data_007(db_conn):
    """
...
@pytest.mark.p0
def test_db_openubmc_has_data_008(db_conn):
    """
...
@pytest.mark.p0
def test_db_ascendnpuir_has_data_009(db_conn):
    """
...
@pytest.mark.p1
def test_db_torchnpu_fields_not_null_010(db_conn):
    """
    [正常流] Torch-NPU 数据必填字段非空
    对应 TASK-2 | 优先级 P1 | 来源 PR #456
    """
    cur = db_conn.cursor()
    cur.execute("""
...
@pytest.mark.p1
def test_db_torchnpu_uuid_format_011(db_conn):
    """
...
@pytest.mark.p0
def test_api_detail_page_torchnpu_012(api_headers):
    """
...
@pytest.mark.p0
def test_api_detail_page_openubmc_013(api_headers):
    """
...
@pytest.mark.p0
def test_api_detail_page_ascendnpuir_014(api_headers):
    """
...
@pytest.mark.p1
def test_api_detail_page_empty_community_015(api_headers):
    """
    [异常] 空社区参数返回参数校验失败
    对应 TASK-2 | 优先级 P1 | 来源 PR #456
    """
...
@pytest.mark.p1
def test_api_detail_page_invalid_community_016(api_headers):
    """
    [异常] 非法社区名返回错误
    对应 TASK-2 | 优先级 P1 | 来源 PR #456
    """
...
@pytest.mark.p1
def test_api_detail_page_missing_community_017(api_headers):
    """
    [空值] 缺失社区参数返回错误
    对应 TASK-2 | 优先级 P1 | 来源 PR #456
    """
...
@pytest.mark.p1
def test_api_detail_page_null_community_018(api_headers):
    """
    [空值] null 社区参数返回错误
    对应 TASK-2 | 优先级 P1 | 来源 PR #456
    """
...
@pytest.mark.p2
def test_api_detail_page_pagination_019(api_headers):
    """
    [正常流] 分页参数有效
    对应 TASK-3 | 优先级 P2 | 来源 PR #456
    """
    resp = requests.post(
        f"{BASE_API}/server/detail/page",
        headers=api_headers,
...
@pytest.mark.p2
def test_api_detail_page_large_pagesize_020(api_headers):
    """
...
@pytest.mark.p2
def test_api_detail_page_pagesize_zero_021(api_headers):
    """
...
@pytest.mark.p2
def test_api_detail_page_negative_page_022(api_headers):
    """
    [异常输入] page=-1 返回错误
    对应 TASK-3 | 优先级 P2 | 来源 PR #456
    """
...
@pytest.mark.p2
def test_api_detail_page_negative_pagesize_023(api_headers):
    """
...
@pytest.mark.p1
def test_db_torchnpu_status_values_024(db_conn):
    """
...
@pytest.mark.p1
def test_db_torchnpu_issue_state_values_025(db_conn):
    """
...
@pytest.mark.p2
def test_db_torchnpu_html_url_format_026(db_conn):
    """
    [正常流] Torch-NPU html_url 为有效 GitCode 链接
    对应 TASK-2 | 优先级 P2 | 来源 PR #456
    """
    cur = db_conn.cursor()
...
@pytest.mark.p2
def test_db_openubmc_html_url_format_027(db_conn):
    """
...
@pytest.mark.p2
def test_db_ascendnpuir_html_url_format_028(db_conn):
    """
...
@pytest.mark.p2
def test_api_detail_page_community_case_sensitive_029(api_headers):
    """
    [异常输入] 社区名大小写敏感性测试
    对应 TASK-3 | 优先级 P2 | 来源 PR #456
    """
...
@pytest.mark.p2
def test_api_detail_page_special_chars_community_030(api_headers):
    """
    [特殊字符] 社区名含特殊字符返回错误
    对应 TASK-3 | 优先级 P2 | 来源 PR #456
    """
...
@pytest.mark.p2
def test_api_detail_page_sql_injection_031(api_headers):
    """
...
@pytest.mark.p2
def test_db_torchnpu_score_range_032(db_conn):
    """
...
@pytest.mark.p2
def test_db_torchnpu_assign_at_valid_date_033(db_conn):
    """
...
@pytest.mark.p2
def test_db_torchnpu_created_at_valid_date_034(db_conn):
    """
...
@pytest.mark.p2
def test_db_openubmc_fields_not_null_035(db_conn):
    """
...
@pytest.mark.p2
def test_db_ascendnpuir_fields_not_null_036(db_conn):
    """
...
@pytest.mark.p2
def test_api_detail_page_type_mismatch_page_037(api_headers):
    """
...
@pytest.mark.p2
def test_api_detail_page_type_mismatch_pagesize_038(api_headers):
    """
...
@pytest.mark.p2
def test_api_detail_page_empty_body_039(api_headers):
    """
    [空值] 空请求体返回错误
    对应 TASK-3 | 优先级 P2 | 来源 PR #456
    """
...
@pytest.mark.p2
def test_api_detail_page_invalid_json_040():
    """
    [异常输入] 非 JSON 请求体返回错误
    对应 TASK-3 | 优先级 P2 | 来源 PR #456
    """
...
@pytest.mark.p1
def test_api_detail_page_empty_data_041(api_headers):
    """
    [空数据] 空表数据返回空列表无报错
    对应 TASK-3 | 优先级 P1 | 来源 PR #456
    """
    resp = requests.post(
        f"{BASE_API}/server/detail/page",
        headers=api_headers,
...
# |--------|------|-----------|--------|---------|
# | TC-API-001 | 社区列表接口返回包含 Torch-NPU | TASK-1 | P0 | #456 |
# | TC-API-002 | 社区列表接口返回包含 openUBMC | TASK-1 | P0 | #456 |
# | TC-API-003 | 社区列表接口返回包含 Ascend IR | TASK-1 | P0 | #456 |
# | TC-DB-004 | fact_torchnpu_practice 表存在且结构正确 | TASK-2 | P0 | #456 |
# | TC-DB-005 | fact_openubmc_practice 表存在且结构正确 | TASK-2 | P0 | #456 |
# | TC-DB-006 | fact_ascendnpuir_practice 表存在且结构正确 | TASK-2 | P0 | #456 |
# | TC-DB-007 | fact_torchnpu_practice 表有数据 | TASK-2 | P0 | #456 |
# | TC-DB-008 | fact_openubmc_practice 表有数据 | TASK-2 | P0 | #456 |
# | TC-DB-009 | fact_ascendnpuir_practice 表有数据 | TASK-2 | P0 | #456 |
# | TC-DB-010 | Torch-NPU 数据必填字段非空 | TASK-2 | P1 | #456 |
# | TC-DB-011 | Torch-NPU uuid 格式正确 | TASK-2 | P1 | #456 |
# | TC-API-012 | 查询 Torch-NPU 社区数据接口返回正确（含14字段验证） | TASK-2 | P0 | #456 |
# | TC-API-013 | 查询 openUBMC 社区数据接口返回正确（含14字段验证） | TASK-2 | P0 | #456 |
# | TC-API-014 | 查询 Ascend IR 社区数据接口返回正确（含14字段验证） | TASK-2 | P0 | #456 |
# | TC-API-015 | 空社区参数返回4xx参数校验失败 | TASK-2 | P1 | #456 |
# | TC-API-016 | 非法社区名返回500或4xx错误 | TASK-2 | P1 | #456 |
# | TC-API-017 | 缺失社区参数返回错误 | TASK-2 | P1 | #456 |
# | TC-API-018 | null 社区参数返回错误 | TASK-2 | P1 | #456 |
# | TC-API-019 | 分页参数有效 | TASK-3 | P2 | #456 |
# | TC-API-020 | pageSize=100 返回正确 | TASK-3 | P2 | #456 |
# | TC-API-021 | pageSize=0 返回空列表或错误 | TASK-3 | P2 | #456 |
# | TC-API-022 | page=-1 返回错误 | TASK-3 | P2 | #456 |
# | TC-API-023 | pageSize=-1 返回错误 | TASK-3 | P2 | #456 |
# | TC-DB-024 | Torch-NPU status 字段值为预期枚举 | TASK-2 | P1 | #456 |
# | TC-DB-025 | Torch-NPU issue_state 字段值为 open 或 closed | TASK-2 | P1 | #456 |
# | TC-DB-026 | Torch-NPU html_url 为有效 GitCode 链接 | TASK-2 | P2 | #456 |
# | TC-DB-027 | openUBMC html_url 为有效 GitCode 链接 | TASK-2 | P2 | #456 |
# | TC-DB-028 | Ascend IR html_url 为有效 GitCode 链接 | TASK-2 | P2 | #456 |
# | TC-API-029 | 社区名大小写敏感性测试 | TASK-3 | P2 | #456 |
# | TC-API-030 | 社区名含特殊字符返回错误 | TASK-3 | P2 | #456 |
# | TC-API-031 | 社区名含 SQL 注入关键字返回错误 | TASK-2 | P2 | #456 |
# | TC-DB-032 | Torch-NPU score 字段范围合理 | TASK-2 | P2 | #456 |
# | TC-DB-033 | Torch-NPU assign_at 为有效时间戳 | TASK-2 | P2 | #456 |
# | TC-DB-034 | Torch-NPU created_at 为有效时间戳 | TASK-2 | P2 | #456 |
# | TC-DB-035 | openUBMC 数据必填字段非空 | TASK-2 | P2 | #456 |
# | TC-DB-036 | Ascend IR 数据必填字段非空 | TASK-2 | P2 | #456 |
# | TC-API-037 | page 参数类型错误返回错误 | TASK-3 | P2 | #456 |
# | TC-API-038 | pageSize 参数类型错误返回错误 | TASK-3 | P2 | #456 |
# | TC-API-039 | 空请求体返回错误 | TASK-3 | P2 | #456 |
# | TC-API-040 | 非 JSON 请求体返回错误 | TASK-3 | P2 | #456 |
# | TC-API-041 | 空表数据返回空列表无报错 | TASK-3 | P1 | #456 |
#
# ===== 覆盖维度统计 =====
