...
| PR | Issue | 合入时间 | 说明 |
|----|-------|---------|------|
| — | — | 2026-08-07 | 首版：只读冒烟（health / projects / search / 鉴权负向） |
...
- **被测环境**: `https://oss-map.test.osinfra.cn`
...
- **功能自检测试** — 健康检查、项目列表/详情/搜索、元数据选项、全局搜索、组织列表
- **安全与隐私测试（轻量）** — `/me` 无 Token、错误登录、受保护导出接口无 Token → 401
