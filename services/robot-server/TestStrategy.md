...
|-------|-----------|----------|------|
| [#346](https://github.com/agentic-develop-playground/backlog/pull/346) | #889 | 2026-05-27 | 初始创建：robot-server 重复 issue 自动检测与关联测试策略 |
...
- **模块名称**: robot-server
- **模块职责**: 机器人服务（监听代码托管平台 Webhook 事件，自动处理 Issue/PR）
- **核心目标**:
  验证机器人服务功能正确性，以及架构设计中定义的安全与隐私、可靠性与韧性、可服务性与可观测性和性能与伸缩性等非功能专项任务的闭环验收。
- **开发责任人**: TBD
- **测试责任人**: TBD
...
#### 3.1.1 IssueOpenedHook 组织白名单过滤（来源 issue #889）
...
#### 3.1.2 DuplicateDetector 相似度算法（来源 issue #889）
...
#### 3.1.3 SimilarityCommenter 评论发送（来源 issue #889）
...
#### 3.3.1 GitHub API 集成（来源 issue #889）
...
| GitHub API 集成 | ✓ (TC-INT-001,002) | ✓ (TC-INT-003,004,005) | N/A | N/A | N/A | N/A | N/A | N/A | N/A | 外部 API 边界由 GitHub 控制 |
