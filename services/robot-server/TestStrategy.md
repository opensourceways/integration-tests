...
> **模块归属**: services/robot-server/
> **覆盖范围**: robot-server 相关需求的模块级测试策略融合文档
...
|-------|-----------|----------|----------|
| [#341](https://github.com/agentic-develop-playground/backlog/pull/341) | #889 | 2026-05-27 | 新增：robot-server 重复 issue 自动检测与关联测试策略 |

---

## 1. 基本信息

- **需求链接**: N/A (E2E smoke — 验证两个 workflow 拉取 Test-Design-Agent.md / Integration-Test-Agent.md)
- **需求名称**: robot-server 在新 issue 创建时自动检测疑似重复并评论关联
- **核心目标**:
  验证重复检测功能正确性，以及架构设计中定义的可靠性与韧性、可服务性与可观测性等非功能专项任务的闭环验收。
- **开发责任人**: TBD
- **测试责任人**: TBD
